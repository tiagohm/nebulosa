...
import nebulosa.adql.Circle
import nebulosa.adql.Column
import nebulosa.adql.ConstellationBoundary
import nebulosa.adql.From
import nebulosa.adql.InnerJoin
import nebulosa.adql.Limit
import nebulosa.adql.QueryBuilder
import nebulosa.adql.SkyPoint
import nebulosa.adql.SortBy
import nebulosa.adql.contains
...
class SimbadServiceTest {
    ...
    companion object {
        ...
        private val SERVICE = SimbadService(httpClient = HTTP_CLIENT)
        private val BASIC_TABLE = From("basic").alias("b")
        private val IDENT_TABLE = From("ident").alias("i")
        private val OTYPES_TABLE = From("otypes").alias("o")
        private val FLUX_TABLE = From("allfluxes").alias("f")

        private val OID_COLUMN = BASIC_TABLE.column("oid")
        private val MAIN_ID_COLUMN = BASIC_TABLE.column("main_id")
        private val OTYPE_COLUMN = BASIC_TABLE.column("otype")
        private val RA_COLUMN = BASIC_TABLE.column("ra")
        private val DEC_COLUMN = BASIC_TABLE.column("dec")
        private val PM_RA_COLUMN = BASIC_TABLE.column("pmra")
        private val PM_DEC_COLUMN = BASIC_TABLE.column("pmdec")
        private val PLX_COLUMN = BASIC_TABLE.column("plx_value")
        private val RAD_VAL_COLUMN = BASIC_TABLE.column("rvz_radvel")
        private val REDSHIFT_COLUMN = BASIC_TABLE.column("rvz_redshift")
        private val NAME_COLUMN = IDENT_TABLE.column("id")
        private val MAG_COLUMN = FLUX_TABLE.column("V")
    }
}
