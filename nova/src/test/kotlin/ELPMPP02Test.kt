...
class ELPMPP02Test : StringSpec() {
    ...
    init {
        ...
        "moon" {
            ...
            v[0] shouldBe (5.762732121285166E-04 plusOrMinus 1e-7)
            v[1] shouldBe (2.476878261262097E-04 plusOrMinus 1e-7)
            v[2] shouldBe (8.902329774047208E-05 plusOrMinus 1e-7)
        }
    }
}
