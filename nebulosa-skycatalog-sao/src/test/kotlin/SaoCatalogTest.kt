...
class SaoCatalogTest : StringSpec() {
    ...
    init {
        "load" {
            ...
            catalog.first().rightAscensionJ2000.value shouldBe ("0  00  05.097".hours.value plusOrMinus 1e-14)
            catalog.first().declinationJ2000.value shouldBe ("82  41  41.82".deg.value plusOrMinus 1e-14)
            catalog.first().magnitude shouldBe 7.2
            catalog.first().spType shouldBe "A0"

            catalog.last().id shouldBe 258997
            catalog.last().rightAscensionJ2000.value shouldBe ("23 58 52.487".hours.value plusOrMinus 1e-14)
            catalog.last().declinationJ2000.value shouldBe ("-83 48 05.02".deg.value plusOrMinus 1e-14)
