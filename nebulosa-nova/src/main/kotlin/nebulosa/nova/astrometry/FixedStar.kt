...
data class FixedStar(
    ...
    companion object {
        ...
        private fun computePositionAndVelocity(
            ...
            parallax: Angle = 0.0, radial: Velocity = 0.0,
        ): PositionAndVelocity {
            ...
            val k = 1.0 / (1.0 - radial.toMetersPerSecond / SPEED_OF_LIGHT)
            ...
            val rvl = radial.toKilometersPerSecond * DAYSEC / AU_KM * k
