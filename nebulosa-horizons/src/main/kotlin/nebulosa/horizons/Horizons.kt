...
interface Horizons {
    ...
    companion object {
        ...
        const val OBSERVER_API_URL =
            "horizons.api?format=text&MAKE_EPHEM=YES&EPHEM_TYPE=OBSERVER&COORD_TYPE=GEODETIC&REF_SYSTEM='ICRF'&CAL_FORMAT='CAL'&TIME_DIGITS='MINUTES'&ANG_FORMAT='DEG'&RANGE_UNITS='AU'&SUPPRESS_RANGE_RATE='YES'&SKIP_DAYLT='NO'&SOLAR_ELONG='0,180'&OBJ_DATA='NO'&CSV_FORMAT='YES'&ELEV_CUT='-90'"
