...
export class SlideMenuComponent implements OnInit {
	...
	@Input()
	appendTo: Nullable<HTMLElement | ElementRef | TemplateRef<unknown> | string>

	@Output()
	onNext = new EventEmitter<MenuItemCommandEvent>()

	@Output()
	onBack = new EventEmitter<MenuItemCommandEvent>()
