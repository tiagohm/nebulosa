...
export class ExposureTimeComponent implements AfterViewInit, OnChanges {
	...
	@Output()
	exposureTimeChange = new EventEmitter<number>()

	@Input()
	unit: ExposureTimeUnit = 'MICROSECOND'

	@Output()
	unitChange = new EventEmitter<ExposureTimeUnit>()

	@Input()
	min: number = 0

	@Input()
	max: number = 600000000

	@Input()
	disabled: boolean = false

	@Input()
	canExposureTime: boolean = true

	@Input()
	canExposureTimeUnit: boolean = true
