...
export class AlignmentComponent implements AfterViewInit, OnDestroy, Tickable {
	...
	preference = structuredClone(DEFAULT_ALIGNMENT_PREFERENCE)
	tppaRequest = this.preference.tppaRequest
	tppaResult = structuredClone(DEFAULT_TPPA_RESULT)
	darvRequest = this.preference.darvRequest
