...
enum class Compression(
     ...
     */
    ZBITPIX(HduType.ANY, ValueType.INTEGER, "", FitsKeywordDictionary.BITPIX),
     ...
     */
    ZNAXIS(HduType.ANY, ValueType.INTEGER, "", FitsKeywordDictionary.NAXIS),
     ...
     */
    ZNAXISn(HduType.ANY, ValueType.INTEGER, "", FitsKeywordDictionary.NAXISn),
     ...
     */
    ZSIMPLE(HduType.PRIMARY, ValueType.LOGICAL, "", FitsKeywordDictionary.SIMPLE),
    ...
    ZTENSION(HduType.ANY, ValueType.STRING, "", FitsKeywordDictionary.XTENSION),
     ...
     * only be used if the original uncompressed image was contained in the primary array of the FITS file.
     */
    ZEXTEND(HduType.PRIMARY, ValueType.LOGICAL, "", FitsKeywordDictionary.EXTEND),
    ...
    ZBLOCKED(HduType.PRIMARY, ValueType.LOGICAL, "", FitsKeywordDictionary.BLOCKED),
     ...
     * keyword.may only be used if the original uncompressed image was contained in in IMAGE extension.
     */
    ZPCOUNT(HduType.EXTENSION, ValueType.INTEGER, "", FitsKeywordDictionary.PCOUNT),
     ...
     * keyword.may only be used if the original uncompressed image was contained in in IMAGE extension.
     */
    ZGCOUNT(HduType.EXTENSION, ValueType.INTEGER, "", FitsKeywordDictionary.GCOUNT),
     ...
     */
    ZFORMn(HduType.ANY, ValueType.STRING, "", FitsKeywordDictionary.TFORMn),
    ...
    private val header = FitsKeywordItem(name, hduType, valueType, comment)
