...
data class DeepSkyObjectEntity(
    ...
    @Column(name = "magnitude", columnDefinition = "REAL") override var magnitude: Double = 99.0,
    ...
    @Column(name = "major_axis", columnDefinition = "REAL") override var majorAxis: Angle = Angle.ZERO,
    @Column(name = "minor_axis", columnDefinition = "REAL") override var minorAxis: Angle = Angle.ZERO,
    @Column(name = "orientation", columnDefinition = "REAL") override var orientation: Angle = Angle.ZERO,
