...
data class SkyObject(
    ...
    val mB: Double = Double.MAX_VALUE, // B magnitude
    val mV: Double = Double.MAX_VALUE, // V magnitude
    val ra: Angle = Angle.ZERO, // RA
    val dec: Angle = Angle.ZERO, // DEC
    val type: SkyObjectType = SkyObjectType.UNKNOWN,
    val mType: String = "", // Morphological type of object
    val majorAxis: Angle = Angle.ZERO, // Major axis size
    val minorAxis: Angle = Angle.ZERO, // Minor axis size
    val orientation: Angle = Angle.ZERO, // Orientation angle
    val redshift: Double = 0.0, // Redshift
    val parallax: Angle = Angle.ZERO, // Parallax
    // TODO: Use Distance type.
    val distance: Double = 0.0, // Distance (Mpc for galaxies, kpc for other objects)
    val pmRA: Angle = Angle.ZERO,
    val pmDEC: Angle = Angle.ZERO,
) {

    val position by lazy { FixedStar(ra, dec, pmRA, pmDEC, parallax) }
