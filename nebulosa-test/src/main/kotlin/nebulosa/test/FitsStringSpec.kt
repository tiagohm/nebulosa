...
abstract class FitsStringSpec : StringSpec() {
    ...
    protected val NGC3344_COLOR_32_FITS_PATH by lazy { download("NGC3344.Color.32.fits", GITHUB_FITS_URL) }
    protected val NGC3344_COLOR_F32_FITS_PATH by lazy { download("NGC3344.Color.F32.fits", GITHUB_FITS_URL) }
    protected val NGC3344_COLOR_F64_FITS_PATH by lazy { download("NGC3344.Color.F64.fits", GITHUB_FITS_URL) }
    protected val NGC3344_MONO_8_FITS_PATH by lazy { download("NGC3344.Mono.8.fits", GITHUB_FITS_URL) }
    protected val NGC3344_MONO_16_FITS_PATH by lazy { download("NGC3344.Mono.16.fits", GITHUB_FITS_URL) }
