...
class JMetro() {
    ...
    val styleProperty: ObjectProperty<Style> = object : SimpleObjectProperty<Style>(Style.LIGHT) {
    ...
    fun reApplyTheme() {
        ...
        stylesheetsList.remove(Style.LIGHT.styleStylesheetURL)
        stylesheetsList.remove(Style.DARK.styleStylesheetURL)
