...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("jackson-kt", "com.fasterxml.jackson.module:jackson-module-kotlin:2.17.2")
            ...
            library("netty-transport", "io.netty:netty-transport:4.1.112.Final")
            ...
            library("grpc-stub", "io.grpc:grpc-kotlin-stub:1.4.1")
            library("grpc-protobuf", "io.grpc:grpc-protobuf:1.66.0")
            library("grpc-netty", "io.grpc:grpc-netty-shaded:1.66.0")
            library("protobuf", "com.google.protobuf:protobuf-kotlin:4.27.3")
...
include(":nebulosa-grpc")
include(":nebulosa-grpc-client")
include(":nebulosa-grpc-driver")
include(":nebulosa-grpc-indi")
include(":nebulosa-grpc-server")
