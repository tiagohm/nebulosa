...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            library("okio", "com.squareup.okio:okio:3.10.2")
            ...
            library("jackson-jsr310", "com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.18.2")
            library("jackson-kt", "com.fasterxml.jackson.module:jackson-module-kotlin:2.18.2")
            ...
            library("oshi", "com.github.oshi:oshi-core:6.6.6")
            ...
            library("flyway", "org.flywaydb:flyway-core:11.3.3")
            library("exposed-core", "org.jetbrains.exposed:exposed-core:0.59.0")
            library("exposed-jdbc", "org.jetbrains.exposed:exposed-jdbc:0.59.0")
            library("ktor-core", "io.ktor:ktor-server-core-jvm:3.1.0")
            library("ktor-websockets", "io.ktor:ktor-server-websockets:3.1.0")
            library("ktor-content-negotiation", "io.ktor:ktor-server-content-negotiation:3.1.0")
            library("ktor-jackson", "io.ktor:ktor-serialization-jackson:3.1.0")
            library("ktor-call-logging", "io.ktor:ktor-server-call-logging:3.1.0")
            library("ktor-cors", "io.ktor:ktor-server-cors:3.1.0")
            library("ktor-host-common", "io.ktor:ktor-server-host-common:3.1.0")
            library("ktor-resources", "io.ktor:ktor-server-resources:3.1.0")
            library("ktor-status-pages", "io.ktor:ktor-server-status-pages:3.1.0")
            library("ktor-netty", "io.ktor:ktor-server-netty:3.1.0")
            library("kotest", "io.kotest:kotest-assertions-core:5.9.1")
            library("junit-api", "org.junit.jupiter:junit-jupiter-api:5.12.0")
            library("junit-engine", "org.junit.jupiter:junit-jupiter-engine:5.12.0")
