...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("logback", "ch.qos.logback:logback-classic:1.4.13")
            library("eventbus", "org.greenrobot:eventbus-java:3.3.1")
            library("netty-transport", "io.netty:netty-transport:4.1.101.Final")
            library("netty-codec", "io.netty:netty-codec:4.1.101.Final")
