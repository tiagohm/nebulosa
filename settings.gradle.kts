...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("jackson-core", "com.fasterxml.jackson.core:jackson-databind:2.19.0")
            library("jackson-jsr310", "com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.19.0")
            library("jackson-kt", "com.fasterxml.jackson.module:jackson-module-kotlin:2.19.0")
