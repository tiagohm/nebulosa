...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("logback", "ch.qos.logback:logback-classic:1.5.13")
            library("eventbus", "org.greenrobot:eventbus-java:3.3.1")
            library("netty-transport", "io.netty:netty-transport:4.1.116.Final")
            library("netty-codec", "io.netty:netty-codec:4.1.116.Final")
            ...
            library("ktor-websockets", "io.ktor:ktor-server-websockets:3.0.2")
            library("ktor-content-negotiation", "io.ktor:ktor-server-content-negotiation:3.0.2")
            library("ktor-jackson", "io.ktor:ktor-serialization-jackson:3.0.2")
            library("ktor-call-logging", "io.ktor:ktor-server-call-logging:3.0.2")
            library("ktor-cors", "io.ktor:ktor-server-cors:3.0.2")
            library("ktor-host-common", "io.ktor:ktor-server-host-common:3.0.2")
            library("ktor-resources", "io.ktor:ktor-server-resources:3.0.2")
