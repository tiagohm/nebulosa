...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("netty-transport", "io.netty:netty-transport:4.1.100.Final")
            library("netty-codec", "io.netty:netty-codec:4.1.100.Final")
            ...
            library("sqlite", "org.xerial:sqlite-jdbc:3.43.2.2")
            library("flyway", "org.flywaydb:flyway-core:10.0.0")
