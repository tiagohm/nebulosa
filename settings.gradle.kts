...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("netty-transport", "io.netty:netty-transport:4.1.111.Final")
            library("netty-codec", "io.netty:netty-codec:4.1.111.Final")
            library("xml", "com.fasterxml:aalto-xml:1.3.3")
            library("csv", "de.siegmar:fastcsv:3.2.0")
            library("apache-lang3", "org.apache.commons:commons-lang3:3.15.0")
