...
class ErfaTest : StringSpec() {
    ...
    init {
        ...
        "eraApcs" {
            ...
            astro.ebx.value shouldBe (-0.9741827110629881886 plusOrMinus 1e-12)
            astro.eby.value shouldBe (-0.2115130190136415986 plusOrMinus 1e-12)
            astro.ebz.value shouldBe (-0.09179840186954412099 plusOrMinus 1e-12)
        ...
        "eraApco" {
            ...
            astro.pmt shouldBe (13.25248468622587269 plusOrMinus 1e-11)
            astro.ebx.value shouldBe (-0.9741827110630322720 plusOrMinus 1e-12)
            astro.eby.value shouldBe (-0.2115130190135344832 plusOrMinus 1e-12)
            astro.ebz.value shouldBe (-0.09179840186949532298 plusOrMinus 1e-12)
        ...
        "eraApcg" {
            ...
            astrom.ebx.value shouldBe (0.901310875 plusOrMinus 1e-12)
            astrom.eby.value shouldBe (-0.417402664 plusOrMinus 1e-12)
            astrom.ebz.value shouldBe (-0.180982288 plusOrMinus 1e-12)
        ...
        "eraApcg13" {
            ...
            astrom.pmt shouldBe (12.65133794027378508 plusOrMinus 1e-11)
            astrom.ebx.value shouldBe (0.9013108747340644755 plusOrMinus 1e-12)
            astrom.eby.value shouldBe (-0.4174026640406119957 plusOrMinus 1e-12)
            astrom.ebz.value shouldBe (-0.1809822877867817771 plusOrMinus 1e-12)
        ...
        "eraP06e" {
            ...
            e[0].value shouldBe (0.4090926006005828715 plusOrMinus 1e-14)
            e[1].value shouldBe (0.6664369630191613431e-3 plusOrMinus 1e-14)
            e[2].value shouldBe (0.4090925973783255982 plusOrMinus 1e-14)
            e[3].value shouldBe (0.5561149371265209445e-6 plusOrMinus 1e-14)
            e[4].value shouldBe (-0.6191517193290621270e-5 plusOrMinus 1e-14)
            e[5].value shouldBe (0.6216441751884382923e-5 plusOrMinus 1e-14)
            e[6].value shouldBe (3.052014180023779882 plusOrMinus 1e-14)
            e[7].value shouldBe (0.4090864054922431688 plusOrMinus 1e-14)
            e[8].value shouldBe (0.1387703379530915364e-5 plusOrMinus 1e-14)
            e[9].value shouldBe (0.2921789846651790546e-3 plusOrMinus 1e-14)
            e[10].value shouldBe (0.3178773290332009310e-3 plusOrMinus 1e-14)
            e[11].value shouldBe (0.2650932701657497181e-3 plusOrMinus 1e-14)
            e[12].value shouldBe (0.6651637681381016288e-3 plusOrMinus 1e-14)
            e[13].value shouldBe (0.1398077115963754987e-5 plusOrMinus 1e-14)
            e[14].value shouldBe (0.4090864090837462602 plusOrMinus 1e-14)
            e[15].value shouldBe (0.6664464807480920325e-3 plusOrMinus 1e-14)
        }
        "eraNumat" {
