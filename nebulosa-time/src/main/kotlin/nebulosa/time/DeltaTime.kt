...
interface DeltaTime {
    ...
    object Standard : DeltaTime {

        private val DAILY_TT = bufferedResource("DAILY_TT.dat") { readDoubleArrayLe(18702) }
        private val DAILY_DELTA_T = bufferedResource("DAILY_DELTA_T.dat") { readDoubleArrayLe(18702) }
        ...
        init {
            ...
            val x = (DAILY_TT[0] - 1721045.0) / DAYSPERJY // TT to J centuries
            ...
            x0 = (DAILY_TT.last() - 1721045.0) / DAYSPERJY  // TT to J centuries
        ...
        override fun delta(time: InstantOfTime): Double {
            ...
            val dt = interpolation(value, DAILY_TT, DAILY_DELTA_T, Double.NaN, Double.NaN)
            return if (dt.isNaN()) CURVE.compute((value - 1721045.0) / DAYSPERJY)
            else dt
        }
    }

    data class Offset(val offset: Double) : DeltaTime {
