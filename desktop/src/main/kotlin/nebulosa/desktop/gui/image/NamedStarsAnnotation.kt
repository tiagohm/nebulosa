...
data class NamedStarsAnnotation(
    val calibration: Calibration,
    val header: Header,
) : Drawable {

    private val data: List<NamedStar>
    private val wcs = WCSTransform(header)
    ...
    init {
        ...
        LOG.info("found {} named stars around coodinate RA={} DEC={}", data.size, center.first.hours, center.second.degrees)
    }
    ...
    companion object {
        ...
        private const val STAR_SIZE = 28.0

        @JvmStatic private val LOG = LoggerFactory.getLogger(NamedStarsAnnotation::class.java)
        @JvmStatic private val DATA = ArrayList<NamedStar>(4000)
