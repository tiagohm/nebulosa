...
value class Distance(val value: Double) {
     ...
     */
    inline val kilometers
        get() = value * AU_KM

    /**
     * Converts this distance to light-years.
     */
    inline val lightYears
        get() = value / (SPEED_OF_LIGHT * 31557600 / AU_M)

    /**
     * Converts this distance to parsecs.
     */
    inline val parsecs
        get() = value / 206264.806245480309552772371736702884
    ...
    companion object {
        ...
        inline val Double.parsec
            get() = (this * 206264.806245480309552772371736702884).au
