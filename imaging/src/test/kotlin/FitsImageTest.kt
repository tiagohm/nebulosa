...
class FitsImageTest : ImageTest() {
    ...
    init {
        "8-bits mono" {
            ...
            val image = FitsImage(fits).also(Image::read)
        ...
        "STF midtone = 0.1, shadow = 0.0, highlight = 1.0" {
            val fits = Fits("src/test/resources/M51.8.Color.fits")
            val image = ScreenTransformFunction(0.1f).transform(FitsImage(fits).also(Image::read))
        ...
        "STF midtone = 0.9, shadow = 0.0, highlight = 1.0" {
            val fits = Fits("src/test/resources/M51.8.Color.fits")
            val image = ScreenTransformFunction(0.9f).transform(FitsImage(fits).also(Image::read))
        ...
        "STF midtone = 0.1, shadow = 0.5, highlight = 1.0" {
            val fits = Fits("src/test/resources/M51.8.Color.fits")
            val image = ScreenTransformFunction(0.1f, shadow = 0.5f).transform(FitsImage(fits).also(Image::read))
        ...
        "STF midtone = 0.9, shadow = 0.5, highlight = 1.0" {
            val fits = Fits("src/test/resources/M51.8.Color.fits")
            val image = ScreenTransformFunction(0.9f, shadow = 0.5f).transform(FitsImage(fits).also(Image::read))
        ...
        "STF midtone = 0.1, shadow = 0.0, highlight = 0.5" {
            val fits = Fits("src/test/resources/M51.8.Color.fits")
            val image = ScreenTransformFunction(0.1f, highlight = 0.5f).transform(FitsImage(fits).also(Image::read))
        ...
        "STF midtone = 0.9, shadow = 0.0, highlight = 0.5" {
            val fits = Fits("src/test/resources/M51.8.Color.fits")
            val image = ScreenTransformFunction(0.9f, highlight = 0.5f).transform(FitsImage(fits).also(Image::read))
        ...
        "STF midtone = 0.1, shadow = 0.4, highlight = 0.6" {
            val fits = Fits("src/test/resources/M51.8.Color.fits")
            val image = ScreenTransformFunction(0.1f, 0.4f, 0.6f).transform(FitsImage(fits).also(Image::read))
        ...
        "STF midtone = 0.9, shadow = 0.4, highlight = 0.6" {
            val fits = Fits("src/test/resources/M51.8.Color.fits")
            val image = ScreenTransformFunction(0.9f, 0.4f, 0.6f).transform(FitsImage(fits).also(Image::read))
        ...
        "CCD Simulator - Stretch" {
            ...
            val image = ScreenTransformFunction(5.8e-5f).transform(FitsImage(fits).also(Image::read))
        ...
        "Flip Vertical" {
            val fits = Fits("src/test/resources/M51.8.Color.fits")
            val image = Flip(vertical = true).transform(FitsImage(fits).also(Image::read))
        ...
        "Flip Horizontal" {
            val fits = Fits("src/test/resources/M51.8.Color.fits")
            val image = Flip(horizontal = true).transform(FitsImage(fits).also(Image::read))
        ...
        "Flip Vertical & Horizontal" {
            val fits = Fits("src/test/resources/M51.8.Color.fits")
            val image = Flip(horizontal = true, vertical = true).transform(FitsImage(fits).also(Image::read))
        ...
        "Invert" {
            val fits = Fits("src/test/resources/M51.8.Color.fits")
            val image = Invert.transform(FitsImage(fits).also(Image::read))
        ...
        "Grayscale" {
            val fits = Fits("src/test/resources/M51.8.Color.fits")
            val image = Grayscale.BT709.transform(FitsImage(fits).also(Image::read))
        ...
        "Salt & Pepper Noise" {
            ...
            val image = SaltAndPepperNoise(0.1f, Random(0)).transform(FitsImage(fits).also(Image::read))
        ...
        "Blur" {
            val fits = Fits("src/test/resources/Flower.fits")
            val image = Blur().transform(FitsImage(fits).also(Image::read))
        ...
        "Gaussian Blur" {
            val fits = Fits("src/test/resources/Flower.fits")
            val image = GaussianBlur(sigma = 5.0, size = 9).transform(FitsImage(fits).also(Image::read))
        ...
        "Edges" {
            val fits = Fits("src/test/resources/Flower.fits")
            val image = Edges().transform(FitsImage(fits).also(Image::read))
        ...
        "Sharpen" {
            val fits = Fits("src/test/resources/Flower.fits")
            val image = Sharpen().transform(FitsImage(fits).also(Image::read))
        ...
        "Mean" {
            val fits = Fits("src/test/resources/Flower.fits")
            val image = TransformAlgorithm.of(SaltAndPepperNoise(0.1f, Random(0)), Mean()).transform(FitsImage(fits).also(Image::read))
